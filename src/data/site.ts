...
export const projects: readonly Project[] = [
	{
		...
		summary: "Women's fashion store in Colatina, Brazil — bags, jewelry and fragrances.",
		image: shotMavie,
		side: 'left',
	},
	{
		...
		summary: 'Digital marketing agency — video production, paid media and web development.',
		image: shotYerus,
		side: 'right',
	},
	{
		...
		summary: 'Retreat schedule with live countdown, checklist and PDF export.',
		image: shotCdr,
		side: 'left',
	},
	{
		...
		summary: 'Cleaning products manufacturer in Colatina, Brazil — wholesale only.',
